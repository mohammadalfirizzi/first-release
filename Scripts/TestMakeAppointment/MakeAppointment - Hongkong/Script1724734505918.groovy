...
WebUI.callTestCase(findTestCase('TestLogin/Test Login Valid'), [('ns_username') : 'John Doe', ('ns_password') : 'ThisIsNotAPassword'], 
...
WebUI.callTestCase(findTestCase('TestMakeAppointment/MakeAppointment - Tokyo'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('TestMakeAppointment/MakeAppointment - Seoul'), [:], FailureHandling.STOP_ON_FAILURE)
